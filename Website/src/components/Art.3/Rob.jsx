        ...
        <main id="robing">
            ...
            <section id="content">
                <article id="rob">
                    ...
                    <figure>
                        <img src="./src/pictures/Rob/line-oda.png" alt="Bilde av Line og Oda" />
            ...
            <div className="row" id="first">
                <div className="clock">
                    ...
                    <figure>
                        <img src="../src/pictures/Rob/1800.png" alt="Illustrasjon av " />
                        <figcaption className="photographer">
            ...
            <div className="row">
                <div className="clock">
                    ...
                    <figure>
                        <img src="../src/pictures/Rob/1820.png" alt="kollektiv-bilde" />
                        <figcaption className="photographer">
                            Illustratør: Anne May Omberg
                        </figcaption>
                    </figure>
            ...
            <div className="row">
                <div className="clock">
                    ...
                    <figure>
                        <img src="../src/pictures/Rob/1830.png" alt="kollektiv-bilde" />
                        <figcaption className="photographer">
                            Illustratør: Anne May Omberg
                        </figcaption>
                    </figure>
            ...
            <div className="row">
                <div className="clock">
                    ...
                    <figure>
                        <img src="../src/pictures/Rob/1835.png" alt="kollektiv-bilde" />
                        <figcaption className="photographer">
                            Illustratør: Anne May Omberg
                        </figcaption>
                    </figure>
            ...
            <div className="row">
                <div className="clock">
                    ...
                    <figure>
                        <img src="../src/pictures/Rob/1837.png" alt="kollektiv-bilde" />
                        <figcaption className="photographer">
                            Illustratør: Anne May Omberg
                        </figcaption>
                    </figure>
            ...
            <div className="row">
                <div className="clock">
                    ...
                    <figure>
                        <img src="../src/pictures/Rob/1838-39.png" alt="kollektiv-bilde" />
                        <figcaption className="photographer">
                            Illustratør: Anne May Omberg
                        </figcaption>
                    </figure>
            ...
            <div className="row">
                <div className="clock">
                    ...
                    <figure>
                        <img src="../src/pictures/Rob/1842-59.png" alt="kollektiv-bilde" />
                        <figcaption className="photographer">
                            Illustratør: Anne May Omberg
                        </figcaption>
                    </figure>
            ...
            <div className="row">
                <section className="content">
                    ...
                    <figure>
                        <img src="./src/pictures/Rob/Line.jpg" alt="Bilde av Line" />
                        <p className="photo-text">
                        Line-Aurora Herberg Thorvaldsen (17)
                        </p>
                        <figcaption className="photographer">
