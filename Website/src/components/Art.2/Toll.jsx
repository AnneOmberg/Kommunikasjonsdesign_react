            ...
            <main id="toll">
                ...
                <section id="content">
                    <article>
                        ...
                        <p className="sitat" id="SPESIELL-ID">-	Det er en regning som kommer på toppen av alt annet, som man egentlig aldri har råd til, sier Gitte Yvonne Bjørndal Olsen (55) fra Sarpsborg.</p>
                        <h3></h3>
