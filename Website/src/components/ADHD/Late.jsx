        ...
        <main id="late">
            ...
            <section id="content">
                <article id="sent">
                    ...
                    <p className="sitat">- Det at det gikk på skinner å få diagnosen er jo sant, men det er jo lite folk og dårlig tid på DPS, så jeg har jo gått på medisiner i snart et år som ikke fungerer optimalt, og det er ingen som har ringt for å høre hvordan det går på en måte. Så det var veldig sånn samlepunkt-følelse, at du bare skulle gjennom den papirbunken også når du var ferdig med det så var det sånn: stempel og check, signatur og ferdig med det, ha det og håper vi aldri ser deg igjen. Og det er jo problematisk fordi det er veldig mange ting i mitt liv som har skjedd, som man kanskje kunne hatt behov for å prosessere sammen med noen. Så den oppfølgingen i etterkant er vel det jeg kanskje vil fremheve som mest problematisk, hvis man skal snakke om sånn utredning og støtteapparat. For støtteapparat opplever jeg ikke at det er i det hele tatt. Så der har jeg måttet ta initiativ på egen hånd, og da må det gå via fastlegen som sender henvisning til DPS som da må vurdere om du har rett på oppfølging. Så man må jo regne med at det tar lang tid, må regne med måneder. </p>
