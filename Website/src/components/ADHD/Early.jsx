        ...
        <main id="late">
            ...
            <section id="content">
                <article id="sent">
                    ...
                    <p className="sitat">- Også fikk jeg jo liksom lite informasjon om hva ADHD var, og da blir det på en måte til at du føler deg så utenfor, at du ikke er normal da, selv om man selvfølgelig er normal selv om man har det.</p>
